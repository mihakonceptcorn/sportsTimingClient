...
<!--    </ButtonComponent>-->
    ...
    <Sidebar v-model:visible="visible" position="right" :transitionOptions="'.3s cubic-bezier(0, 0, 0.2, 1)'" class="layout-config-sidebar w-20rem">
        ...
        <div class="flex align-items-center">
            <ButtonComponent icon="pi pi-minus" type="button" @click="decrementScale()" class="p-button-text p-button-rounded w-2rem h-2rem mr-2" :disabled="layoutConfig.scale.value === scales[0]"></ButtonComponent>
            <div class="flex gap-2 align-items-center">
                <i class="pi pi-circle-fill text-300" v-for="s in scales" :key="s" :class="{ 'text-primary-500': s === layoutConfig.scale.value }"></i>
            </div>
            <ButtonComponent icon="pi pi-plus" type="button" pButton @click="incrementScale()" class="p-button-text p-button-rounded w-2rem h-2rem ml-2" :disabled="layoutConfig.scale.value === scales[scales.length - 1]"></ButtonComponent>
        </div>
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-light-blue', 'light')">
                    <img src="/layout/images/themes/bootstrap4-light-blue.svg" class="w-2rem h-2rem" alt="Bootstrap Light Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-light-purple', 'light')">
                    <img src="/layout/images/themes/bootstrap4-light-purple.svg" class="w-2rem h-2rem" alt="Bootstrap Light Purple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-dark-blue', 'dark')">
                    <img src="/layout/images/themes/bootstrap4-dark-blue.svg" class="w-2rem h-2rem" alt="Bootstrap Dark Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('bootstrap4-dark-purple', 'dark')">
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('md-light-indigo', 'light')">
                    <img src="/layout/images/themes/md-light-indigo.svg" class="w-2rem h-2rem" alt="Material Light Indigo" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('md-light-deeppurple', 'light')">
                    <img src="/layout/images/themes/md-light-deeppurple.svg" class="w-2rem h-2rem" alt="Material Light DeepPurple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('md-dark-indigo', 'dark')">
                    <img src="/layout/images/themes/md-dark-indigo.svg" class="w-2rem h-2rem" alt="Material Dark Indigo" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('md-dark-deeppurple', 'dark')">
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('mdc-light-indigo', 'light')">
                    <img src="/layout/images/themes/md-light-indigo.svg" class="w-2rem h-2rem" alt="Material Light Indigo" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('mdc-light-deeppurple', 'light')">
                    <img src="/layout/images/themes/md-light-deeppurple.svg" class="w-2rem h-2rem" alt="Material Light Deep Purple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('mdc-dark-indigo', 'dark')">
                    <img src="/layout/images/themes/md-dark-indigo.svg" class="w-2rem h-2rem" alt="Material Dark Indigo" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('mdc-dark-deeppurple', 'dark')">
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('tailwind-light', 'light')">
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('fluent-light', 'light')">
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-light-indigo', 'light')">
                    <img src="/layout/images/themes/lara-light-indigo.png" class="w-2rem h-2rem" alt="Lara Light Indigo" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-light-blue', 'light')">
                    <img src="/layout/images/themes/lara-light-blue.png" class="w-2rem h-2rem" alt="Lara Light Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-light-purple', 'light')">
                    <img src="/layout/images/themes/lara-light-purple.png" class="w-2rem h-2rem" alt="Lara Light Purple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-light-teal', 'light')">
                    <img src="/layout/images/themes/lara-light-teal.png" class="w-2rem h-2rem" alt="Lara Light Teal" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-dark-indigo', 'dark')">
                    <img src="/layout/images/themes/lara-dark-indigo.png" class="w-2rem h-2rem" alt="Lara Dark Indigo" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-dark-blue', 'dark')">
                    <img src="/layout/images/themes/lara-dark-blue.png" class="w-2rem h-2rem" alt="Lara Dark Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-dark-purple', 'dark')">
                    <img src="/layout/images/themes/lara-dark-purple.png" class="w-2rem h-2rem" alt="Lara Dark Purple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('lara-dark-teal', 'dark')">
        ...
        <div class="grid">
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('saga-blue', 'light')">
                    <img src="/layout/images/themes/saga-blue.png" class="w-2rem h-2rem" alt="Saga Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('saga-green', 'light')">
                    <img src="/layout/images/themes/saga-green.png" class="w-2rem h-2rem" alt="Saga Green" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('saga-orange', 'light')">
                    <img src="/layout/images/themes/saga-orange.png" class="w-2rem h-2rem" alt="Saga Orange" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('saga-purple', 'light')">
                    <img src="/layout/images/themes/saga-purple.png" class="w-2rem h-2rem" alt="Saga Purple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('vela-blue', 'dark')">
                    <img src="/layout/images/themes/vela-blue.png" class="w-2rem h-2rem" alt="Vela Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('vela-green', 'dark')">
                    <img src="/layout/images/themes/vela-green.png" class="w-2rem h-2rem" alt="Vela Green" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('vela-orange', 'dark')">
                    <img src="/layout/images/themes/vela-orange.png" class="w-2rem h-2rem" alt="Vela Orange" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('vela-purple', 'dark')">
                    <img src="/layout/images/themes/vela-purple.png" class="w-2rem h-2rem" alt="Vela Purple" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('arya-blue', 'dark')">
                    <img src="/layout/images/themes/arya-blue.png" class="w-2rem h-2rem" alt="Arya Blue" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('arya-green', 'dark')">
                    <img src="/layout/images/themes/arya-green.png" class="w-2rem h-2rem" alt="Arya Green" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('arya-orange', 'dark')">
                    <img src="/layout/images/themes/arya-orange.png" class="w-2rem h-2rem" alt="Arya Orange" />
                </ButtonComponent>
            </div>
            <div class="col-3">
                <ButtonComponent class="p-link w-2rem h-2rem" @click="onChangeTheme('arya-purple', 'dark')">
